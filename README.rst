...
Poll Everywhere (http://www.polleverywhere.com/)::
    ...
    - regex: ['http://www.polleverywhere.com/polls/*','http://www.polleverywhere.com/multiple_choice_polls/*','http://www.polleverywhere.com/free_text_polls/*']
    - endpoint: http://www.polleverywhere.com/services/oembed/

iFixit (http://www.iFixit.com)::

    - regex: ['http://www.ifixit.com/Guide/View/*']
...
WordPress.com (http://wordpress.com/)::
    ...
    - regex: ['regex:.*.wordpress\.com/.*',]
    - endpoint: http://public-api.wordpress.com/oembed/
    - for: 'plone' is sent as a friend
